...
window.onload = function() {
  ...
  canvas.addEventListener('mousemove', function(evt) {
    ...
    paddle1Y = mousePos.y - paddleHeight / 4;
  })
}
...
function drawEverything() {
  ...
  //Middle Circle 1
  colorCircle((canvas.width / 2), canvas.height / 2, 50, 'black');
  //Center Line
  colorRect((canvas.width - 20) / 2, 0, 20, canvas.height, 'orange')
  //Ball
  colorCircle(ballX, ballY, 10, 'black');
  //Paddle Left 
  colorRect(5, paddle1Y, paddleWidth, paddleHeight, 'Gold')
  //Paddle Right
  colorRect(685, paddle2Y, paddleWidth, paddleHeight, 'Red')
}
